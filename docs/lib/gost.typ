...
#let init(body) = {
       titlepage(authors: ("В.Д. Панков",), city: "Санкт-Петербург", department: "Кафедра № 43", documentName: "ОТЧЁТ ПО ЛАБОРАТОРНОЙ РАБОТЕ №5", title: ["Множественное наследование в языке С++"], education: "ГУАП", group: "М412", teachers: ("Е.О. Шумова", ), position: "старший преподаватель", object: [Основы программирования])
